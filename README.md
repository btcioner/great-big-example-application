...
Ambitransportous| | | | |[UNIQUE.]( "Feathers.js")|
[API introspection report and testing interface (?)](http://www.javarepl.com/console.html "a simple, interactive computer programming environment that takes single user inputs (i.e. single expressions), evaluates them, and returns the result to the user")|[UNIQUE.]( "JHipster,Swagger")| | | | |
...
Authorization, Role-based|[X.]( "JHipster")| | | |[X.]( "Feathers.js")|
[Automated device testing](https://github.com/google/web-starter-kit/wiki/Why-another-boilerplate%3F "")|[X.]( "BrowserSync,BrowserSync")| |[X.](https://github.com/mgechev/angular-seed/wiki/Add-a-Proxy-to-browsersync "BrowserSync")|[X.](https://github.com/mgechev/angular-seed/wiki/Add-a-Proxy-to-browsersync "BrowserSync")| |
back end generator|[X.]( "JHipster")| | | |[X.]( "Feathers.js")|
[Blog](https://github.com/angular-app/angular-app/issues/19 "")|UNIQUE| | | | |
Breadcrumbs| |UNIQUE| | | |
Can run on a desktop without a browser| | | |[UNIQUE.]( "Electron")| |
[Chatroom specifically for the technology, supports markdown](http://stackshare.io/stackups/slack-vs-gitter#more "")|[X.](http://stackshare.io/stackups/slack-vs-gitter#more "Gitter,Gitter,Gitter")|[X.](http://stackshare.io/stackups/slack-vs-gitter#more "Gitter")|[X.](http://stackshare.io/stackups/slack-vs-gitter#more "Gitter,Gitter")|[X.](http://stackshare.io/stackups/slack-vs-gitter#more "Gitter,Gitter")| |
Client-side dependency injection|[X.]( "Angular 2.0,Angular 2.0,Angular 2.0,Spring MVC,Java 7,Java 7,Java 7,Angular 2.0")|[X.]( "Angular 2.0,Angular 2.0,Angular 2.0")|[X.]( "Angular 2.0")|[X.]( "Angular 2.0,Angular 2.0,Angular 2.0")| |
...
[Client-side routing, State-based routing](http://angularclass.com/angularconnect-2015-a-highlights-tour/ "")|[X.](http://angularclass.com/angularconnect-2015-a-highlights-tour/ "Angular 2.0,Angular 2.0,JHipster,Angular 2.0")|[X.](http://angularclass.com/angularconnect-2015-a-highlights-tour/ "Angular 2.0,Angular 2.0,Angular 2.0")|[X.](http://angularclass.com/angularconnect-2015-a-highlights-tour/ "Angular 2.0")|[X.](http://angularclass.com/angularconnect-2015-a-highlights-tour/ "Angular 2.0,Angular 2.0,Angular 2.0")| |
Client-side unit tests|X|X|X|X| |
[Clustered HTTP sessions (?)](https://www.owasp.org/index.php/Main_Page "I think this needs to be reorganized.  I think the authentication types are possibilities of local authentication    Some security packages to consider:  Kraken  Helmet.js  Lusca    Douglas Crockford: In a safe system, references can only be obtained by creation, construction and introduction")|[UNIQUE.]( "JHipster")| | | | |
Code coverage reporting|[X.]( "Mocha,karma-coverage,Istanbul")|[X.]( "Mocha")| | |[X.]( "Istanbul,Mocha")|
[Command line interface (CLI) (?)](https://github.com/Hashnode/mern-cli "Generates boilerplate code")|[X.](https://github.com/vuejs/vue-cli "angular-cli,Spring MVC,Yeoman,Maven,Gradle,Vue")|[X.]( "angular-cli")| | |[X.](https://github.com/facebookincubator/create-react-app "React,React")|
[Command line interface (CLI), can do database migration/evolution](https://en.wikipedia.org/wiki/Ruby_on_Rails "")|[UNIQUE.]( "Liquibase")| | | | |
Compiled, supports ahead of time (AOT) compilation|X| |X|[X.]( "mgechev's angular-seed")| |
Components communicate with events|X|X| | | |
Concurrency (synchronization), immutable data|X|[X.]( "Immutable,ng-redux")| |[X.]( "ngrx")|[X.]( "Redux")|
[Concurrency (synchronization), supports database transactions (?)](https://en.wikipedia.org/wiki/Software_transactional_memory "a concurrency control mechanism analogous to database transactions for controlling access to shared memory in concurrent computing")|[UNIQUE.]( "JHipster")| | | | |
...
[Cross-Origin Resource Sharing (CORS) (?)](https://www.reddit.com/r/javascript/comments/3la78q/what_to_learn_as_a_frontend_framework_angular_or/cv4lc12 "Not having this is rare but I had to put it down because it's a big gotcha of React.")|[X.]( "JHipster")| | | |X|
...
[Database connection pooling (?)](https://github.com/DaftMonk/generator-angular-fullstack/issues/642 "A server-side system to handle delegation of asynchronous tasks, like sending email messages, to the resources available to do them")|[UNIQUE.]( "JHipster")| | | | |
...
[Development build, html page processing (?)](https://github.com/dustinspecker/generator-ng-poly/issues/96 "This goes with the step below.  To prevent asset files (css and js) from being cached, they are given unique names and the index.html file that refers to them is updated")|[UNIQUE.]( "JHipster")| | | | |
[Development build, script](http://www.letscodejavascript.com/v3/episodes/live/15 "")|[UNIQUE.]( "JHipster")| | | | |
...
[Error handling, Server-side logging](https://github.com/jirutka/spring-rest-exception-handler "")|[X.](https://github.com/jhipster/generator-jhipster/issues/894 "Logback")| |[X.]( "Express")|[X.]( "Express,Express")|[X.]( "Express")|
External, 3rd party, API interaction|X|X| | | |
FEATURE (a.k.a. module, entity) generator|[UNIQUE.]( "JHipster")| | | | |
...
[Graphical schema editing (?)](https://ionic.io/products/creator "A tool for designing user interfaces that lets you modify the user interface directly instead of coding it in a text editor")|[UNIQUE.]( "JDL Studio")| | | | |
Grid|UNIQUE| | | | |
...
[Instrumentation, Metrics, server-side](http://dynofy.com/ "")|[UNIQUE.]( "JHipster")| | | | |
[Lazy (on-demand) loading of client-side code](http://blog.durandal.io/2015/05/20/porting-an-angular-2-0-app-to-aurelia/#comment-2036657491 "")|[X.]( "Angular 2.0,Angular 2.0,Angular 2.0,Spring MVC,Angular 2.0")|[X.]( "Angular 2.0,Angular 2.0,Angular 2.0")|[X.]( "Angular 2.0")|[X.]( "Angular 2.0,Angular 2.0,Angular 2.0")| |
Local storage|X|X| | |X|
...
[Modularized, route-specific CSS (?)](https://github.com/atomify/atomify-css "Reusable front-end styling using Rework, plugins, and Node's resolve algorithm    allows you to build nice little components that can be shared across apps    you may use atomify-css with CSS or LESS, you cannot combine them in the same workflow")|[X.]( "Angular 2.0,Angular 2.0,Angular 2.0")|[X.]( "Angular 2.0,Angular 2.0,Angular 2.0")|[X.]( "Angular 2.0")|[X.]( "Angular 2.0,Angular 2.0,Angular 2.0")| |
...
[Object-relational mapping](https://www.quora.com/Which-is-better-between-laravel-and-ruby-on-rails/answer/Prabhakar-Bhat?srid=XaU8&share=1 "")|[X.]( "JHipster")| | | |[X.]( "Feathers.js")|
[Observables for databinding a.k.a. KVO (?)](http://blog.durandal.io/2015/05/20/porting-an-angular-2-0-app-to-aurelia/#comment-2054431151 "+ It makes things happen without a lot of code    -This can be prone to infinite loop problems")|[X.](http://blog.durandal.io/2015/05/20/porting-an-angular-2-0-app-to-aurelia/#comment-2054431151 "RxJS,RxJS")|[X.](http://blog.durandal.io/2015/05/20/porting-an-angular-2-0-app-to-aurelia/#comment-2054431151 "RxJS,RxJS")|[X.](http://blog.durandal.io/2015/05/20/porting-an-angular-2-0-app-to-aurelia/#comment-2054431151 "RxJS,RxJS,JS ES2016")|[X.](http://blog.durandal.io/2015/05/20/porting-an-angular-2-0-app-to-aurelia/#comment-2054431151 "RxJS,RxJS,JS ES2016,RxJS,RxJS")| |
...
[Pagination, paging (server-side)](https://github.com/dancancro/great-big-example-application/blob/master/src/main/java/org/exampleapps/greatbig/web/rest/TagResource.java#L98 "")|[X](https://github.com/dancancro/great-big-example-application/blob/master/src/main/java/org/exampleapps/greatbig/web/rest/TagResource.java#L98)| | | |[X.]( "Feathers.js")|
Pagination, paging (server-side), with sorting|UNIQUE| | | | |
Panels, draggable| |UNIQUE| | | |
[Persistent, server-side data storage (?)](http://hammerprinciple.com/databases "Structured Query Language. For use with data in related tables.")|[X.](https://jhipster.github.io/2016/12/08/jhipster-release-3.12.1.html "MongoDB,SQL Server,MySQL,Postgresql,MongoDB,Cassandra,ElasticSearch")| |[X.](http://expressjs.com/guide/database-integration.html "MySQL,Postgresql,SQLite,MongoDB,CouchDB,ElasticSearch,LevelDB,Cassandra,Neo4J")|[X.](http://expressjs.com/guide/database-integration.html "MySQL,Postgresql,SQLite,MongoDB,CouchDB,ElasticSearch,LevelDB,Cassandra,Neo4J")|[X.](http://expressjs.com/guide/database-integration.html "MySQL,Postgresql,SQLite,MongoDB,CouchDB,ElasticSearch,LevelDB,Cassandra,Neo4J,MongoDB,Postgresql,MongoDB,Rethinkdb,CouchDB")|
[Preloads client-side data (?)](https://www.youtube.com/watch?v=33kl0iQByME&list=UUEGUP3TJJfMsEM_1y8iviSQ#t=963 "This can be useful for caching videos    Blog about it http://www.dwmkerr.com/promises-in-angularjs-the-definitive-guide/")|[X.]( "Angular 2.0,Angular 2.0,Angular 2.0")|[X.]( "Angular 2.0,Angular 2.0,Angular 2.0")|[X.]( "Angular 2.0")|[X.]( "Angular 2.0,Angular 2.0,Angular 2.0")| |
[Production build, generate docs](http://kapeli.com/docsets "")| |[X.]( "typedoc")| |[X.]( "typedoc")| |
Production build, safe pre-minification|[X.]( "Angular 2.0,Angular 2.0,Angular 2.0,ng-annotate,Angular 2.0")|[X.]( "Angular 2.0,Angular 2.0,Angular 2.0")|[X.]( "Angular 2.0")|[X.]( "Angular 2.0,Angular 2.0,Angular 2.0")| |
...
[route (client side) generator](https://github.com/Swiip/generator-gulp-angular/issues/9 "")|[UNIQUE.]( "JHipster")| | | | |
[Safe from clickjacking (?)](https://github.com/meanjs/mean/issues/848 "Applies a rigorous validation to passwords to make sure they are secure")|[UNIQUE.]( "JHipster")| | | | |
[Safe from session id hacks (?)](http://en.wikipedia.org/wiki/Message_authentication_code "Server generates Message Authentication Codes from important, by-user-read-only data")|[UNIQUE.]( "JHipster")| | | | |
...
Server-side caching|[UNIQUE.]( "JHipster")| | | | |
[Server-side integration & unit tests](http://willnathan.com/nodejs-vs-ruby-on-rails "")|[X.]( "Mocha,JUnit,Mockito,Mockito")|[X.]( "Mocha")| | |[X.]( "Mocha")|
...
[State inspection tools (?)](http://mochajs.org/ "It will update the code in the client without users needing to do anything")|[X.]( "redux-devtools")|[X.]( "redux-devtools,redux-devtools")| |[X.]( "redux-devtools")|[X.]( "redux-devtools")|
...
[Supports database layer triggers (?)](https://github.com/dancancro/great-big-example-application/blob/master/src/main/webapp/app/core/store/entity "only one piece of the application flow is tasked with mutating state data")|[X.](https://github.com/dancancro/great-big-example-application/blob/master/src/main/webapp/app/core/store/entity "JHipster")| | | |[X.]( "Feathers.js")|
[Tables](http://railscasts.com/episodes/340-datatables?autoplay=true "")|UNIQUE| | | | |
[Templating, parsable HTML, no imperative code allowed](http://railscasts.com/episodes/269-template-inheritance "")|[X.]( "Angular 2.0")|[X.]( "Angular 2.0")|[X.]( "Angular 2.0")|[X.]( "Angular 2.0,Angular 2.0")| |
[Time travel, undo (?)](https://github.com/dancancro/great-big-example-application/blob/master/src/main/webapp/app/core/core.module.ts#L95 "After a code change the page will reload and put you in the same place you were in before without losing state.")|[X.](https://github.com/dancancro/great-big-example-application/blob/master/src/main/webapp/app/core/core.module.ts#L95 "ngrx,ngrx")|[X.]( "ng-redux")| |[X.]( "ngrx")|[X.]( "Redux")|
Timepicker|UNIQUE| | | | |
[To do list](http://www.quora.com/What-is-the-best-open-source-solution-for-implementing-fast-auto-complete "")|UNIQUE| | | | |
[Two-way data binding (?)](https://medium.com/@davidsouther/song-flux-e1f9786579f6 "Reduces boilerplate and is easier to reason about than traditional data binding    Facebook engineers recognized that allowing data to flow in two directions created applications that were difficult to reason about. Hence, the concept of unidirectional data flow was introduced. Specifically, Flux says that data should flow down: starting at the topmost component and then down the tree.")|[X.](https://medium.com/@davidsouther/song-flux-e1f9786579f6 "Angular 2.0,Angular 2.0,Angular 2.0,Angular 2.0")|[X.](https://medium.com/@davidsouther/song-flux-e1f9786579f6 "Angular 2.0,Angular 2.0,Angular 2.0")|[X.](https://medium.com/@davidsouther/song-flux-e1f9786579f6 "Angular 2.0")|[X.](https://medium.com/@davidsouther/song-flux-e1f9786579f6 "Angular 2.0,Angular 2.0,Angular 2.0")| |
[Typed (?)](http://qr.ae/fe0h2 "This is a good way to check things automatically, but you should be writing unit tests that can accomplish the same thing.    It also makes possible editor assistance by giving you code completion to display available methods for an object.")|[X.](http://www.typescriptlang.org/ "Typescript")|[X.](http://www.typescriptlang.org/ "Typescript")|[X.](http://www.typescriptlang.org/ "Typescript")|[X.](http://www.typescriptlang.org/ "Typescript,Typescript")| |
[Typed, statically (?)](http://php.net/manual/en/book.reflection.php "Reflection makes it possible to inspect classes, interfaces, fields and methods at runtime, without knowing the names of the classes, methods etc. at compile time. It may also be possible to instantiate new objects, invoke methods and get/set field values using reflection")|[X.]( "Typescript")|[X.]( "Typescript")|[X.]( "Typescript")|[X.]( "Typescript,Typescript")| |
[UML to model generation (?)](https://github.com/dustinspecker/generator-ng-poly/releases/tag/v0.7.3 "example: choosing ES2015 for appScript then suggests the same for testScript  same with Mocha and Jasmine for unit and e2e testing framework")|[UNIQUE.]( "JHipster")| | | | |
Update generated code in an existing app|[X.]( "JHipster")| |X|[X.]( "mgechev's angular-seed")| |
[User tracking and analytics](http://jvectormap.com/ "")|X| | |X| |
[Virtual, shadow DOM (?)](https://plus.google.com/u/0/+AngularJS/posts/eZNUbuXwbCm "for browsers that do not support ShadowDOM natively")| | | | |[UNIQUE.]( "React")|
|  | | | | |
